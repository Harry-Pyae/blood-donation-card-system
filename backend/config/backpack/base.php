...
return [
    ...
    */
    ...
    // BloodCare owns these routes so profile fields beyond name/email can be
    // edited while password changes remain an isolated security action.
    ...
    */
    ...
    'middleware_class' => [
        // BloodCare has one users table, so every approved Staff and System
        // Administrator account uses Laravel's canonical web session. Role
        // differences are enforced separately by authorization middleware.
    ...
    // Use a local BloodCare asset. A new Staff/Admin email must never trigger
    // a blocking Gravatar download while Backpack renders the workspace.
    'avatar_type' => 'bloodCareAvatarUrl',
